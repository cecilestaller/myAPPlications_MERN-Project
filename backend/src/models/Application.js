...
const applicationSchema = new mongoose.Schema(
    {
        ...
        applicationType: { type: String, enum: [ "LinkedIn", "Firmenportal", "indeed", "stepstone", "Xing", "E-Mail", "Sontige" ], required: true },
        city: { type: String, required: true },
        workLocation: { type: String, required: true, enum: [ "Hybrid", "Remote", "Vor Ort" ] },
